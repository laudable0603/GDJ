...
SELECT
       TO_CHAR(SYSDATE, 'YYYY-MM-DD AM HHMISS') -- 12시간
     , TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24MISS')  -- 24시간
  FROM
       DUAL;
...
SELECT
     ...
     , TO_CHAR(SYSDATE - 0.5, 'MMDD AM HHMISS') AS 12시간전
     , TO_CHAR(SYSDATE + 0.5, 'MMDD AM HHMISS') AS 12시간후
     , TO_CHAR(SYSDATE + (1  24), 'MMDD AM HHMISS') AS 1시간후
  FROM
       DUAL;
