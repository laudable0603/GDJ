...
CREATE TABLE CUSTOMER (
    CUS_NO     NUMBER NOT NULL, --PK
    CUS_NAME   VARCHAR2(30 BYTE) NOT NULL,
    CUS_PHONE  VARCHAR2(30 BYTE) UNIQUE, --UNIQUE
    CUS_AGE    NUMBER(3) CHECK ( CUS_AGE BETWEEN 0 AND 100 ), --0~100
    BANK_CODE  VARCHAR(20)--FK
);
...
ALTER TABLE CUSTOMER
    ADD CONSTRAINT FK_CUS_BANK FOREIGN KEY ( BANK_CODE )
...
-- 5. 테이블 이름 수정 : ALTER TABLE 테이블 RENAME TO NEW 이름 
