...
/*
	...
	안녕. 난 컨트롤러야.
	@Component에 의해서 자동으로 Bean으로 만들어지고 스프링에서 사용되지.
 */
...
public class MvcController {
	...
	*/
	...
	public String welcome() {
		return "index"; //DispatcherServler의 ViewResolver에 의해서 해석된다 index.jsp 파일 이름
						// prefix="/WEB-INF/views/"
						// suffix=".jsp"
						//prefie와 suffix에 의해서 /WEB-INF/views/index.jsp 와 같이 해석되고 처리된다.
		// index.jsp forward했을까? redirect했을까?
		// 정답 : forward했다
		// redirect할때는 return "redirect: 경로"; 반환
	...
	//@RequestMapping(value="/animal", method=RequestMethod.GET)
	//@RequestMapping(value="animal", method=RequestMethod.GET)    슬래시가 없어도 가능
	//@RequestMapping(value="/animal")							   GET방식은 default
	...
	public String 꽃보러가기() {
		//return "/gallery/flower" 슬래시(/) 있어도 됨
		
		return "gallery/flower";  //슬래시(/) 없어도 됨
	}
	...
	public String 동물보고꽃보고() {
		// redirect: 다음에는 항상 다른 URL Mapping을 적어 준다. 따라서 꽃보러가기 실행
	...
	public void 응답만들기(HttpServletRequest request, HttpServletResponse response) {
		...
		//응답을 만들때는 return을 하지 않는다. void반환
