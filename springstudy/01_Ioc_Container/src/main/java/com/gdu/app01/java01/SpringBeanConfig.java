...
public class SpringBeanConfig {
	...
	public Song asdfghjk1() { // name값을 지정한 뒤 메소드이름은 상관없다.
		Song song = new Song();
		song.setTitle("제목2");
		song.setGenre("장르2");
		return song;
	...
	/*
	  <bean id="song3" class="Song">
	  	<constructor-arg  value="제목2" />
	  	<constructor-arg  value="장르2" />
	  </bean>
	 */
	@Bean
	public Song song3() {
	...
	// setter injection
	@Bean(name="singer2")
	public Singer asdfghjk2() {
		Singer singer = new Singer();
		singer.setName("가수2");
		singer.setSong(asdfghjk1());
		return singer;
