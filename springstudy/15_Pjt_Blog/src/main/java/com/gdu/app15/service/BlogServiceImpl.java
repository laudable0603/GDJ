...
public class BlogServiceImpl implements BlogService {
	...
	public void getBlogList(Model model) {
		...
		Map<String, Object> modelMap = model.asMap(); //model을 map으로 변환
	...
	public Map<String, Object> saveSummernoteImage(MultipartHttpServletRequest multipartRequest) {
		...
		// 저장 경로
		String path = "C:" + File.separator + "upload";
		...
		// 저장할 파일 객체
		File file = new File(dir, filesystem); // new File(path, filesystem)도 가능
	...
	@Override
	public int removeBlog(HttpServletRequest request, HttpServletResponse response) {
		int blogNo = Integer.parseInt(request.getParameter("blogNo"));
		return blogMapper.deleteBlogByNo(blogNo);
