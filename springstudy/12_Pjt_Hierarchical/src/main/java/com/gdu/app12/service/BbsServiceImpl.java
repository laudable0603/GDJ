...
public class BbsServiceImpl implements BbsService {
	...
	public int addBbs(HttpServletRequest request) {
		...
		String title = securityUtil.prevetXSS(request.getParameter("title")); 
	...
	/*
	 	@Transactional
	 	안녕, 난 트랙잭션을 처리하는 애너테이션이야
	 	INSERT/UPDATE/DELETE 중 2개 이상이 호출되는 서비스에 추가하면돼
	 */
	@Transactional
	@Override
