...
public class Main2_JSON {
	...
	public static void m2() {
		...
		System.out.println("[전체 오브젝트] : " + obj);
		System.out.println("[response 오브젝트] :" + obj2);
		System.out.println("[header 오브젝트] : " + obj3);

		System.out.println("[header 오브젝트의 value] : " + resultCode + ", " + resultMsg);
	...
	public static String m5() {
		...
		try {
			...
			urlBuilder.append("?serviceKey=").append(URLEncoder.encode(serviceKey, "UTF-8"));
			urlBuilder.append("&key=9940");//646
	...
	public static void m6() {
		...
		for(int i = 0 ; i < columns.length(); i++) {
			map.put(columns.getString(i), item.get(p[i]));//Object 반환이면 주는 타입 생략 가능
