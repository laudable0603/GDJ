...
/*
	...
	3. 실행(런타임) 할 때 익명 구현 객체가 만들어지면서 동작함
 	...
 	5. 예시
 		...
 		2) a -> System.out.println(a);     매개변수가 하나이거나, 메소드본문이 하나이면 중괄호를 작성하지 않는다.
 		4) () -> System.out.println("Hello"); 매개변수가 없으면 빈괄호를 작성한다.
 		5) (a, b) -> {
 			sysout(a + b);
 			return a + b;						반환타입의 명시를 하지 않는다.
 		}
 		6) (a, b) ->  a + b;			실행문이 return만 있는 경우 return을 작성하지않는다.
 */
...
public class Main {
	...
	public static void main(String[] args) {
		...
		int a = 10;
		int b = 7;
		//Thread thread = new Thread((a, b) -> System.out.println(a + b));
		//thread.start();
