...
public class Main {
	...
	public static void m1() {
		...
		//outputstream - Byte기반의 출력 
		
		File file = new File("c:\\storage", "bi.bin");
		...
		try {
			...
			byte[] b = str.getBytes(StandardCharsets.UTF_8);// str.geyBytes("UTF-8")
			//UTF-8 인식하게 하는 법
	...
	public static void m3() {
		...
		try {
			...
			// 출력
			dos.writeUTF(name);//문자보내기
			dos.writeInt(age);//인트보내기
			dos.writeDouble(height);//더블보내기
