...
public class Main {
	...
	public static void m1() {
		...
		try {
			...
			// 출력스트림을 이용해서 실행하게 되면 언제나 원래있던 파일은 삭제된 후
			// 다시 생성된다.
			fw = new FileWriter(file); // 생성 // new FileWriter(C:\\storage\\m1.txt)와 동일
			// 닫는코드를 생성 권장
	...
	public static void m3() {
		...
		// 3. 스트림의 종료(close)를 자동으로 처리하는 try-catch문을 의믜함
		// 4. 형식
		// try(스트림 생성){
		// 코드
		// }catch(Exception e) {
