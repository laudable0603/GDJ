...
public class XMLWriter {
	...
	public static void main(String[] args) {
		...
		// 각각의 부모태그, 자식 태그, 내용들은 모두 Element이다.
	...
	/*<products>
		 * <product> <Number>100</Number> <name>새우깡</name> <price>1500</price>
		 * </product> /의 의미 : 태그
		 *
		 * <product> <Number>101</Number> <name>양파링</name> <price>2000</price>
		 * </product>
		 *
		 * <product> <Number>102</Number> <name>홈런볼</name> <price>3000</price>
		 * </product>
 *///<products>
		...
		try {
			...
			for (List<String> line : list) {
				// 태그 생성
				Element product = document.createElement("product"); // 태그의 이름
