...
public class Hall {
	...
	public Hall(String hallNaame) {
		this.hallName = hallNaame;
	...
	public void reserve() {
		...
		String seatType = sc.next().trim();
		//S입력 -> seatGroups[0].reserve();
		//R입력 -> seatGroups[1].reserve();
		//A입력 -> seatGroups[2].reserve();
