...
public class SelectOneMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//쿼리문 작성
			// SELECT문의 결과가 단일 행 경우
			// 1. WHERE절에서 PK 또는 UNIQUE 칼럼과 동등 비교(=)를 수행하는 경우
			// 2. 집계 함수의 결과를 조회
			...
			if(rs.next()) { //조회 결과가 있으면
				/*
					...
					|     2    | 인절미|  꿀떡   |  0  |   22/09/07  | <- rs.next() 호출시 rs 포인터의 위치
				...
				*/
				...
				//확인
				System.out.println(board); // Board클래스의 toString() 메소드 동작
			} else {
